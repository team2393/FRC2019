...
public class LEDRobot extends BasicRobot
{
    ...
    public ActivityIndicator activity_indicator = new ActivityIndicator();
    ...
    public void robotInit()
    {
        ...
        do_something.addParallel(new LookBusy(activity_indicator, 1.0));
        ...
        for (int i=0; i<3; ++i)
        {
            ...
            do_something.addSequential(new LookBusy(activity_indicator, 0.2));
        }
